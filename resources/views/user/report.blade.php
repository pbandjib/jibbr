        ...
        <x-card class="w-2/3">
            ...
            <div class="flex flex-col mt-4">
                ...
                <div>
                    ...
                    <p class="text-lg text-neutral-500">Reporting<a class="text-link-primary" href="#">{{$user->username}}</a></p>
                </div>
            </div>
            <form class="flex flex-col mt-6" action="{{route('user.report.store', $user->id)}}" method="POST">
                @csrf
